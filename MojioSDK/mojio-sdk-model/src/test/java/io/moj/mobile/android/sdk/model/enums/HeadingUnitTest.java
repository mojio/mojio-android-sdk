...
public class HeadingUnitTest extends EnumTest<HeadingUnit> {

    @Override
    public Map<String, HeadingUnit> getMapping() {
        // these are defined by the server's contract so should be safe to validate against in tests
        return new ImmutableMap.Builder<String, HeadingUnit>()
                .put("Degree", HeadingUnit.DEGREE)
                .build();
    }
