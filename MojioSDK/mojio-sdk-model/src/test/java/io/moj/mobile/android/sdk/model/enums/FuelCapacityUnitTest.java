...
public class FuelCapacityUnitTest extends EnumTest<FuelCapacityUnit> {

    @Override
    public Map<String, FuelCapacityUnit> getMapping() {
        // these are defined by the server's contract so should be safe to validate against in tests
        return new ImmutableMap.Builder<String, FuelCapacityUnit>()
                .put("Gallons", FuelCapacityUnit.GALLONS)
                .put("Liters", FuelCapacityUnit.LITERS)
                .build();
    }
